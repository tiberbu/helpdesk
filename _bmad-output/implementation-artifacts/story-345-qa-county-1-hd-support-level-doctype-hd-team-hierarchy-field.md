# Story: QA: [County-1] HD Support Level DocType + HD Team hierarchy fields

Status: in-progress
Task ID: mngab5edf2u3p8
Task Number: #345
Workflow: playwright-qa
Model: opus
Created: 2026-04-01T16:53:30.218Z

## Description

## QA Report Task — DO NOT MODIFY CODE

**Review task #337: [County-1] HD Support Level DocType + HD Team hierarchy fields**
...
### What to verify
Read the story file for acceptance criteria: `_bmad-output/implementation-artifacts/story-337-county-1-hd-support-level-doctype-hd-team-hierarchy-fields.md`
...
### Deliverable
Produce `docs/qa-report-task-337.md` with:
...
- Task source: Claude Code Studio task #345
