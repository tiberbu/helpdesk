...
- All tests in `test_hd_time_entry.py` pass. All tests in `helpdesk/tests/test_utils.py` pass. (Point-in-time count removed — hardcoded counts become stale as the suite grows.)
