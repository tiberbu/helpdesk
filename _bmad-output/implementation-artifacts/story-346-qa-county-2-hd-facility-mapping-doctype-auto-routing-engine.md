# Story: QA: [County-2] HD Facility Mapping DocType + auto-routing engine

Status: in-progress
Task ID: mngaesvo64xofh
Task Number: #346
Workflow: playwright-qa
Model: opus
Created: 2026-04-01T16:55:50.075Z

## Description

## QA Report Task — DO NOT MODIFY CODE

**Review task #338: [County-2] HD Facility Mapping DocType + auto-routing engine**
...
### What to verify
Read the story file for acceptance criteria: `_bmad-output/implementation-artifacts/story-338-county-2-hd-facility-mapping-doctype-auto-routing-engine.md`
...
### Deliverable
Produce `docs/qa-report-task-338.md` with:
...
- Task source: Claude Code Studio task #346
