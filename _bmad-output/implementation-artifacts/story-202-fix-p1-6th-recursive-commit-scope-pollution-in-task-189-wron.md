...
- `_bmad-output/implementation-artifacts/story-194-qa-fix-p1-5th-recursive-commit-scope-pollution-in-task-171-u.md` (UNDECLARED — commit scope pollution: QA story artifact updated in same commit)
- `_bmad-output/implementation-artifacts/story-195-qa-fix-p1-commit-scope-pollution-in-task-179-p2-stale-test-c.md` (UNDECLARED — commit scope pollution: QA story artifact updated in same commit)
- `_bmad-output/implementation-artifacts/story-196-fix-p1-recursive-commit-scope-pollution-in-story-182-missing.md` (UNDECLARED — commit scope pollution: story artifact updated in same commit)
- `_bmad-output/implementation-artifacts/story-199-qa-fix-p1-recursive-commit-scope-pollution-in-story-182-miss.md` (UNDECLARED — commit scope pollution: QA story artifact updated in same commit)
- `_bmad-output/implementation-artifacts/story-201-qa-fix-p1-6th-recursive-commit-scope-pollution-in-task-184-u.md` (UNDECLARED — commit scope pollution: QA story artifact updated in same commit)
- `_bmad-output/implementation-artifacts/story-203-fix-p1-commit-bf2e19d09-task-196-bundles-17-files-declaring-.md` (UNDECLARED — commit scope pollution: story artifact created in same commit)
- `_bmad-output/implementation-artifacts/story-204-fix-p1-story-192-claims-credit-for-task-189-work-commit-scop.md` (UNDECLARED — commit scope pollution: story artifact created in same commit)
- `_bmad-output/sprint-status.yaml` (UNDECLARED — commit scope pollution: sprint metadata update)
- `docs/qa-report-task-192.md` (UNDECLARED — commit scope pollution: QA report from task #192)
- `docs/qa-report-task-196.md` (UNDECLARED — commit scope pollution: QA report from task #196)
- `docs/qa-report-task-198.md` (UNDECLARED — commit scope pollution: QA report from task #198)
