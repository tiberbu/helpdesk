# Story: QA: Feat: Team creation/edit UI — add Support Level, Parent Team, Territory fields

Status: in-progress
Task ID: mngez3ovcqhvfx
Task Number: #363
Workflow: playwright-qa
Model: opus
Created: 2026-04-01T19:03:35.910Z

## Description

## QA Report Task — DO NOT MODIFY CODE

**Review task #355: Feat: Team creation/edit UI — add Support Level, Parent Team, Territory fields**
...
### What to verify
Read the story file for acceptance criteria: `_bmad-output/implementation-artifacts/story-355-feat-team-creation-edit-ui-add-support-level-parent-team-ter.md`
...
### Deliverable
Produce `docs/qa-report-task-355.md` with:
...
- Task source: Claude Code Studio task #363
