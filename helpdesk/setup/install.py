...
def add_default_agent_groups():
    ...
    for agent_group in agent_groups:
        if not frappe.db.exists("HD Team", agent_group):
            ...
            agent_group_doc.support_level = "L2 - National"
...
def get_custom_fields():
    """ServiceDesk specific custom fields that needs to be added to the Assignment Rule DocType."""
    return {
        "User": [{
            "fieldname": "facility",
            "fieldtype": "Data",
        ...
        "Assignment Rule": [
            {
                "description": "Autogenerated field by ServiceDesk App",
