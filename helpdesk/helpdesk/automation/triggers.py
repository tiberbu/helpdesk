...
def resolve_trigger_type(doc, method: str) -> str:
    """Resolve the most specific trigger_type for a ticket doc event.
    ...
    Returns:
        The resolved trigger_type string.
    """
    ...
    if method == "on_update":
        ...
        if status:
            ...
            # Re-opened: was previously resolved/closed, now active
    ...
    return DOC_EVENT_TO_TRIGGER.get(method, "ticket_updated")
